...
<!--		<h1>Transit Login Form</h1>-->
        ...
        <% } %>
					<div class="login-agileits-top"> 	
						<form method="post"> 
							<p>User Name </p>
                                                        <input type="text" value="#{usersBean.username}" class="name" name="username" />
							<p>Password</p>
                                                        <input type="password" value="#{usersBean.password}" class="password" name="password" />  
<!--							<label class="anim">
								<input type="checkbox" class="checkbox">
								<span> Remember me ?</span> 
							</label>   -->
<!--                                			<input type="submit" value="Login"> -->
<input type="submit"  name="submit" value="#{usersBean.add()}"/>
						</form> 	
					</div> 
